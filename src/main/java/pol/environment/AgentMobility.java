...
public class AgentMobility implements java.io.Serializable {
	...
	@Skip
	private static boolean placeToAgentSpread;

	public static void initializeSpreadParam(boolean isSpread) {
		placeToAgentSpread = isSpread;
	}

	public static void stopPlaceToAgentSpread() {
	...
	public boolean transport() {
		...
		if (isArrived) {
			...
			if (placeToAgentSpread)
				InfectiousModel.spreadDiseasePlaceToAgent(agent, destinationUnit);
