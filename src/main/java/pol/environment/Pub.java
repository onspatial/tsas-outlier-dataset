...
public class Pub extends BuildingUnit {
	...
	public double getDistance(BuildingUnit buildingUnit) {
		SpatialNetwork network = model.getSpatialNetwork();
		return network.getDistance(this.getLocation(), buildingUnit.getLocation());
	}

	public double getDistance(MasonGeometry location) {
		SpatialNetwork network = model.getSpatialNetwork();
		return network.getDistance(this.getLocation(), location);
	}
