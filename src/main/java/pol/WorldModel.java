...
public class WorldModel extends SimState {
	...
	public void makeAllOutlier(String type, double degree) {
		System.out.println("All agents will be outliers" + "type: " + type + "degree: " + degree);

		for (Person person : this.agents.values()) {
			person.setOutlierType(type, degree);
		}
	}

	public void backAllToNormal() {
		System.out.println("All agent will be normal");
		for (Person person : this.agents.values()) {
			person.backToNormal();
		}
	}
