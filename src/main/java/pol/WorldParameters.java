...
public class WorldParameters extends AnnotatedPropertied {
	...
	public static final LocalDateTime INITIAL_SIMULATION_TIME = LocalDateTime.parse("2024-01-01");
	public static final LocalDateTime WARMUP_PERIOD_END_TIME = LocalDateTime.parse("2024-01-29");
	...
	// Disease Parameters
	public boolean agentToAgentSpread;
	public boolean placeToAgentSpread;
	public int maxNumOfInfectedAgents;
	public int maxNumOfDiseaseDays;
	public double spreadDegreePerStep;
	public double infectionDegreePerStep;
	public double maskWearingThreshold;
	public double maskEffectivity;
	public String exposedLasting;
	public String infectiousLasting;
	public String recoveredLasting;

	// Outlier parameters
	@EditableProperty(group = "Outlier", description = "Chance to be Yellow outlier", lower = "0.0", upper = "1.0", readOnly = false)
	public double chanceToBeYellow;
	@EditableProperty(group = "Outlier", description = "Chance to be Orange outlier", lower = "0.0", upper = "1.0", readOnly = false)
	public double chanceToBeOrange;
	@EditableProperty(group = "Outlier", description = "Chance to be Red outlier", lower = "0.0", upper = "1.0", readOnly = false)
	public double chanceToBeRed;
	...
	protected void initializationWithDefaultValues() {
		...
		// Disease Parameters Default
		maxNumOfInfectedAgents = 0;
		maxNumOfDiseaseDays = 0;
		agentToAgentSpread = false;
		placeToAgentSpread = false;
		spreadDegreePerStep = 0.05;
		infectionDegreePerStep = 0.05;
		maskWearingThreshold = 1;
		maskEffectivity = 0;
		exposedLasting = "0-2016";
		infectiousLasting = "2016-4032";
		recoveredLasting = "288000-2880000";

		// outlier
		chanceToBeYellow = 0.33;
		chanceToBeOrange = 0.33;
		chanceToBeRed = 0.33;
	}
}
